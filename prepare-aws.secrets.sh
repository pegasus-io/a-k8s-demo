...
ssh-keygen -C $LE_COMMENTAIRE_DE_CLEF -t rsa -b 4096 -f $AWS_CREDENTIALS_FILE -q -P "$PEGASUS_DEFAULT_PRIVATE_KEY_PASSPHRASE"

ls -allh $WHERE_TO_CREATE_AWS_CREDENTIALS_FILE
...
export THAS_THE_PUB_KEY=$(cat "$AWS_CREDENTIALS_FILE".pub )
